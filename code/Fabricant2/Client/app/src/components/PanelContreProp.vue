...
const request = require('request');
    ...
    export default {
        ...
        mounted(){
            ...
            var options = {
                url:"http://localhost:4001/proposition",
                method: 'POST',
                headers: {
                ...
                request(options, (err, res) => {
                    ...
                    var optionContre = {
                        url:"http://localhost:4001/contrePropositions",
                        method: 'POST',
                        headers: {
                            'Accept': 'application/json, text/plain, */*',
                            'Content-Type': 'application/json'
        ...
        methods:{
            ...
            sendContreProp(){
                ...
                var options = {
                    url:"http://localhost:4001/addContreProposition",
                    method: 'POST',
                    headers: {
                        'Accept': 'application/json, text/plain, */*',
                        'Content-Type': 'application/json'
            ...
            modifContreProp(){
                ...
                console.log(list);
                var options = {
                    url:"http://localhost:4001/updateContreProposition",
                    method: 'POST',
                    headers: {
                        'Accept': 'application/json, text/plain, */*',
                        'Content-Type': 'application/json'
